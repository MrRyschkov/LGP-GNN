...
def set_all_params(dataset, MODEL_NAME, random_seed):
    ...
    if MODEL_NAME == 'GatedGCN':
        epochs=1000; batch_size=5; init_lr=0.001; lr_reduce_factor=0.5; lr_schedule_patience=10; min_lr = 0.00001; weight_decay=0
    ...
    if MODEL_NAME == 'GAT':
        epochs=1000; batch_size=50; init_lr=0.001; lr_reduce_factor=0.5; lr_schedule_patience=10; min_lr = 0.00001; weight_decay=0
